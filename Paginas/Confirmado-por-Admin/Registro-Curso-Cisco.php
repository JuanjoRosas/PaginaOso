            ...
            <div class="">
                <div class="row d-flex justify-content-center align-items-center h-100">
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                        <form action="../../Controlador/Registrar-Estudiante-Cisco.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-outline mb-4">
                                <input name="codigo" type="text" id="form3Example3" class="form-control form-control-lg"
                                 />
                            ...
                            <div class="form-outline mb-3">
                                <input name="comprobante" type="file" id="form3Example4" class="form-control form-control-lg"
                                />
                            ...
                            <Button name="curso" type="submit" class="btn btn-primary btn-lg"
